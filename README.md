...
- **Headless execution with guardrails** - dotbot runs autonomous AI work non-interactively through provider CLIs, using provider-supported safety modes where available.
